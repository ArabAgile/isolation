...
def custom_score(game, player):
    ...
    p1_moves_num = len(game.get_legal_moves(player))
    p2_moves_num = len(game.get_legal_moves(game.get_opponent(player)))

    return float(p1_moves_num - p2_moves_num)
...
def custom_score_2(game, player):
    ...
    return float(p1_moves_num - 2*p2_moves_num)
...
def custom_score_3(game, player):
    ...
    return float(p1_moves_num - p2_moves_num**2)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def terminal_test(self, game, depth):
        ...
        # return not bool(depth <= 0 or game.get_legal_moves())  # by Assumption 1

    def min_value(self, game, depth):
        # print("AG_LOG min_value() {} ".format(depth))
    ...
    def max_value(self, game, depth):
        # print("AG_LOG max_value() {} ".format(depth))
        if self.terminal_test(game, depth):
            return self.score(game, self)  # by Assumption 2
